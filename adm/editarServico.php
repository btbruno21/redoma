...
if (!empty($_GET['id'])) {
    if (!is_numeric($_GET['id'])){
        ...
        $horas = isset($info['duracao']) ? intdiv($info['duracao'], 60) : 0;
...
<div class="container mt-4 d-flex flex-column align-items-center" data-bs-theme="dark">
    <h1 class="mb-4 w-100 text-center">Editar Serviço</h1>
        ...
        <div class="card-body">
            <form method="POST" action="actions/editarServicoSubmit.php">
                ...
                <div class="mb-3">
                    ...
                    <div class="row g-2">
                        <div class="col-3">
                            <label for="horas" class="form-label small text-muted">Horas</label>
                            <input type="number" name="horas" id="horas" class="form-control"
                                placeholder="Horas" min="0" value="<?php echo $horas; ?>">
                        </div>
                        <div class="col-3">
                            <label for="minutos" class="form-label small text-muted">Minutos</label>
                            <input type="number" name="minutos" id="minutos" class="form-control"
                                placeholder="Minutos" min="0" max="59" value="<?php echo $minutos;?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    <input type="text" name="categoria" class="form-control" placeholder="Categoria"
                           value="<?php echo $info['categoria']; ?>" required>
                </div>
